...
public class TestPipeline {
    public static void main(String[] args) {
        try {
            ...
            BufferedImage image = ImageIO.read(new File("resources/images/test.png"));
